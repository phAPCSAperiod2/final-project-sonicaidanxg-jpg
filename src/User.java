...
public class User {
    ...
    // Image i = new
    // Image("https://cdn12.picryl.com/photo/2016/12/31/deer-whitetail-fawn-animals-087653-1024.jpg",
    // "Image1");
    // i.addImage(i);
    // Image b = new Image(
    ...
    // i.addImage(b);
    // Image c = new Image(
    // "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRg7mqOU8dEnsBAUEoHPwHRv3ITz0uOGnC5Vw&s",
    // "Image3");
    // i.addImage(c);
